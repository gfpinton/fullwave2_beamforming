...
basedir='/kulm/scratch/fullwave2_beamforming_phantom'
%%% Advanced variables %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
betamap=imgaussfilt(betamap,gfilt);
			       ...
			       %zero out maps to make this homogeneous
cmap=cmap*0+c0;
rhomap=rhomap*0+rho0;
Amap=Amap*0+mean(mean(Amap));
betamap=betamap+mean(mean(betamap));
